...
<!-- フッターbtn -->
        <div class="header-name">
			<span class="header-name_btn">販売代理店募集</span>
		</div>
...
?>
	...
	<div class="p-copyright" style="background: <?php echo esc_attr( $options['copyright_bg'] ); ?>;">
		<div class="l-inner">
			...
			<p class="u-clearfix">
				<span class="u-hidden-sm ds-b">株式会社Weaving</span>

				<div class="u-clearfix-box">
					<p class="u-hidden-sm">本社：〒108-0075<br class="sp-br">
						<spam class="u-hidden-sm pd-l">東京都港区港南2-16-2太陽生命品川ビル28F</span>
						<br class="sp-br">
						<span class="u-hidden-sm pd-l">TEL：0120-264-093</span>
					</p>
				</div>

				<div class="u-clearfix-box">
					<p class="u-hidden-sm">大阪支社：〒530-0001<br class="sp-br">
						<span class="u-hidden-sm pd-l">大阪府大阪市北区梅田二丁目5番13号桜橋第一ビル304号</span>
					</p>
				</div>

				<br class="sp-br">
				<span class="small ds-b pd-t">Copyright &copy; <?php bloginfo( 'name' ); ?></span>
			</div>
		</div>
	</div>
<?php if ( is_mobile() && ! is_no_responsive() && '5' === $options['footer_cta_display'] ) { get_template_part( 'template-parts/footer-bar' ); } ?>
<?php 
if ( '5' !== $options['footer_cta_display'] && ! isset( $_COOKIE['tcdHideFooterCTA'] ) ) { 
