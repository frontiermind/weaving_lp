...
<?php if ( 'type1' == $options['header_content_type'] ) : // 画像スライダー ?>
	...
	<!-- 工事中 -->
			<div class="p-index-slider__item p-index-slider__item--<?php echo esc_attr( $options['slider_type' . $i] ); ?>" >
				<img src="<?php echo esc_attr( wp_get_attachment_url( $options['slider_bg_image' . $i ] ) ); ?>" alt="">
	<!-- 工事中 -->
